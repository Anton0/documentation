...
3. In your `serverless.yml`, also add the following section:
    ...
    ```
    For more information on the Forwarder ARN, or to install Forwarder see the [Forwarder documentation][2].
...
After you have configured your function following the steps above, you can view metrics, logs and traces on the [Serverless page][2].
